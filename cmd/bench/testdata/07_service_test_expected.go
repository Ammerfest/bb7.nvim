...
func TestCreateOrder(t *testing.T) {
	...
	order, err := svc.CreateOrder("Alice", []string{"Widget", "Gadget"}, 29.99, "normal")
	if err != nil {
...
func TestCreateOrder_EmptyCustomer(t *testing.T) {
	svc := NewOrderService()
	_, err := svc.CreateOrder("", []string{"Widget"}, 10.00, "normal")
	if err == nil {
...
func TestCreateOrder_NoItems(t *testing.T) {
	svc := NewOrderService()
	_, err := svc.CreateOrder("Bob", nil, 10.00, "normal")
	if err == nil {
...
func TestGetOrder(t *testing.T) {
	svc := NewOrderService()
	created, _ := svc.CreateOrder("Charlie", []string{"Doohickey"}, 15.00, "normal")
...
func TestConfirmOrder(t *testing.T) {
	svc := NewOrderService()
	order, _ := svc.CreateOrder("Diana", []string{"Thingamajig"}, 42.00, "normal")
...
func TestConfirmOrder_NotPending(t *testing.T) {
	svc := NewOrderService()
	order, _ := svc.CreateOrder("Eve", []string{"Widget"}, 10.00, "normal")
