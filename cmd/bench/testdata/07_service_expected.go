...
// CreateOrder creates a new order with the given items and priority.
func (s *OrderService) CreateOrder(customer string, items []string, total float64, priority string) (*Order, error) {
	if customer == "" {
