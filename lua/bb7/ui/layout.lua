...
function M.calc_layout()
  ...
  -- Left column: Info at bottom (fixed 7 lines), Chats and Files split the rest
  local provider_total = math.min(7, total_height) -- Including borders (5 content lines + 2 border)
